...
//     // Adjusted password regex for easier validation (min 6 chars)
...
//         previousClassGrade: formData.previousClassGrade,
...
//       existingStudents[formData.email] = studentData;
//       localStorage.setItem('students', JSON.stringify(existingStudents));

//       // Show success message
//       toast.success('You have successfully registered!', {
//         autoClose: 3000, // Close the toast after 3 seconds
//         onClose: () => navigate('/student-login'), // Redirect to login page after toast is closed
//       });
//     }
//   };
import React, { useState } from 'react';
